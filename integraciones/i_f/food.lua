...
register_food_item(PREFIX .. "fazzoletto_raw", S("Raw Fazzoletto"), modname .. "_fazzoletti.png", 11, 11)
register_food_item(PREFIX .. "gnocco_raw", S("Raw Gnocco"), modname .. "_gnocco.png", 11, 10)
...
register_food_item(PREFIX .. "olive", S("Olives"), modname .. "_olive.png", 3, 4)
register_food_item(PREFIX .. "olive_oil", S("Olive Oil"), modname .. "_olive_oil.png", 7, 4)
register_food_item(PREFIX .. "panettone", S("Panettone"), modname .. "_panettone.png", 7, 8)
register_food_item(PREFIX .. "pandoro", S("Pandoro"), modname .. "_pandoro.png", 7, 8)
register_food_item(PREFIX .. "pesto_sauce", S("Pesto Sauce"), modname .. "_pesto_sauce.png", 7.5, 8)
register_food_item(PREFIX .. "pesto_bruschetta", S("Pesto Sauce Bruschetta"), modname .. "_pesauce_bruschetta.png", 24, 20)
...
register_food_item(PREFIX .. "sheep_milk_bucket", S("Sheep Milk Bucket"), modname .. "_sheep_milk_bucket.png", 8.5, 9)
register_food_item(PREFIX .. "spaghetti", S("Tomato Spaghetti"), modname .. "_spaghetti.png", 12, 10)
register_food_item(PREFIX .. "spaghetti_raw", S("Raw Spaghetti"), modname .. "_spaghetti_raw.png", 10, 10)
register_food_item(PREFIX .. "sunflowerolio", S("Sunflower Oil"), modname .. "_sunfloweroil.png", 5, 3)
register_food_item(PREFIX .. "tiramisu", S("Tiramisu"), modname .. "_tiramisu.png", 12, 8)
